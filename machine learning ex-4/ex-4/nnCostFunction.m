...
a1 = [ones(m,1) X];     %a1 = X -> 1st layer(input layer)
%size(a1)                % 5000x401
z2 = Theta1*a1';
%size(z2)                % 25x5000
a2 = sigmoid(z2);
...
z3 = Theta2*a2;
%size(z3)                % 10x5000
a3 = sigmoid(z3);       %a3 = hx -> output layer
hx = a3;
%size(hx)                % 10x5000
...
for i = 1:m
    a1 = X(i,:);				%a1 = X -> 1st layer(input layer), 1st training ex.
    %size(a1)                           % 1x401
    z2 = Theta1*a1';
    %size(z2)                		% 25x1
    a2 = sigmoid(z2);
    ...
    delta3 = a3 - yvec';     %output layer delta
    %size(delta3)           % 10x1
    %size(Theta2)           % 10x26
